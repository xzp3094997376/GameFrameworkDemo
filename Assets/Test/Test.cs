...
public class Test : MonoBehaviour
{
    ...
    private void OnConnected(object sender, GameEventArgs e)
    {
        ...
        // {
        //     Name = "服务器你好吗？我是"+nameof(CSHello),
        // });
        // iNetworkChannel.Send(new PB.MySecondProto()
        // {
        //     Name = "服务器,你好吗",//+nameof(proto.MySecondProto.MySecondProto).ToString()
        //     PlotId = 1000,
        // });
    }
    /// <summary>
    ...
    public void TestProtoSerilzie()
    {
        MemoryStream ms_out = new MemoryStream();
        ProtoBuf.Serializer.Serialize(ms_out, new PB.MySecondProto()
        {
            name = "服务器,你好吗",//+nameof(proto.MySecondProto.MySecondProto).ToString()
            plotId = 1000,
            results_per_page = 12,
        ...
        var deser = ProtoBuf.Serializer.Deserialize<PB.MySecondProto>(ms_out);
        Debug.Log(deser.name+"," +deser.page_number);
    }
    ...
    {
        Demo8_SocketServer.DisposSocket();
        Debug.Log("销毁socket");
    }
}
